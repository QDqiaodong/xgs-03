...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    List<Comment> findByPostIdOrderByIsBestAnswerDescCreatedAtDesc(Long postId);

    List<Comment> findByPostIdOrderByIsBestAnswerDescLikeCountDescCreatedAtDesc(Long postId);
